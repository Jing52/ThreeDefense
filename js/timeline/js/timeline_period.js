    ...
    (function (win) {
        ...
        TimeLine.prototype = {
            init: function () {
                ...
                this.scaleLen = this.options.scaleLen || 31;
...
//              this.markerTime = parseInt(new Date().Format("hh")) + ":00";
            ...
            resizeViwe: function () {
                this.offsetLeft = this.timeline.width() * 0.04;
                this.width = this.progress.width();
                var tmpLiWidth = this.width * 1 / this.scaleLen;
                this.timeline_scale.css('paddingLeft', this.offsetLeft + tmpLiWidth * 0.40);
                this.width = this.progress.width();
...
//              var nowTime = parseInt(new Date().Format("hh")) + 24;
                var nowTime = parseInt(1) + 31;
                var htmlStr = '';
                for (var i = me.scaleLen; i >0; i--) {
                    var tmpTime = (nowTime - i) % 32 ;
                    htmlStr += "<li>" + tmpTime + "</li>";
                }
                me.markerTime = nowTime % 31 + "";
            ...
            setCount: function (count, time) {
                ...
                var tmpWidth = tmpLi.position().left + tmpLi.width() / 1.5 - me.marker.width() / 1.4;
